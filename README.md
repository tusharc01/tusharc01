...
<h3 align="center">VLSI Enthusiast | ASIC</h3>
...
- Passionate about **VLSI Design**, especially in **ASIC**.
- Completed coursework in Digital Logic, Digital IC Design, Reconfigurable System Design, and ASIC.
- Currently working with **Vivado**, **Cadence** (Genus, Innovus, Tempus), **Synopsys** (Design Compiler, VCS), and real-time FPGA boards like **Basys3/Boolean**.
